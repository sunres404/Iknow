...
<body>
	...
	<form action="${pageContext.request.contextPath }/KindServlet" method="post">
	...
	<c:choose>
		<c:when test="${not empty sessionScope.page }">
			当前页：${page.nowPage }<br>
			最大页：${page.maxPage }<br>
			<form action="${pageContext.request.contextPath }/KindServlet?kind=1&nowPage=${page.nowPage - 1}&order=2" method="post">
